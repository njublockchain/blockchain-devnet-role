...
for u, v, k, edge_data in G.edges(keys=True, data=True):
    if u.startswith("https://api.github.com/repos/"):
        ...
        # v is actor
        new_G.add_edge(v, "https://api.github.com/users/" + u.split("/")[-2], key=k, **edge_data)
    
    elif v.startswith("https://api.github.com/repos/"):
